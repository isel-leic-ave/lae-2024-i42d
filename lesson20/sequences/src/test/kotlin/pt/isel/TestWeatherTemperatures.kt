...
class TestWeatherTemperatures {
    ...
    @Test
    fun weatherDescriptionsOnRainnyDaysMapFilter() {
        var count = 0
    ...
    @Test
    fun weatherDescriptionsOnRainnyDaysFilterMap() {
        var count = 0
        val weatherDescs = weatherData
    ...
    @Test
    fun firstWeatherDescInWindyDaysEager() {
        var count = 0;
    ...
    @Test
    fun firstWeatherDescInWindyDaysLazy() {
        var count = 0;
        val windyDesc = weatherData
            .asSequence()
    ...
    @Test
    fun distinctWeatherDescInWindyDaysEager() {
        var count = 0;
    ...
    @Test
    fun distinctWeatherDescInWindyDaysLazy() {
        var count = 0;
        val distinct = weatherData
            .asSequence()
            .lazyFilter { count++; it.windspeedKmph > 20 } // bigger than 20 Kms/h
    ...
    @Test
    fun testGeneratorNoSuchElementExcetion() {
    ...
    @Test
    fun firstWeatherDescInWindyDaysLazyWithYield() {
        var count = 0;
        val windyDesc = weatherData
            .asSequence()
